    ...
    <>
      ...
      >
        ...
        >
          <img
            ...
            style={{
              ...
              transform: isMobile
                ? solid
                  ? "translateX(-8px) scale(2.19)"
                  : "translateX(-10px) scale(2.44)"
                : solid
                  ? "translateX(-18px) scale(2)"
                  : "translateX(-22px) scale(2.2)",
        ...
        >
          ...
          <a
            href="#contact"
            className="btn-pill btn-dark btn-nav"
